...
Parameters to enable and configure the automatic removing of users from groups if those users are not logged in.
...
Whether to enable automatic group pruning.
...
Parameters to configure the numbers of job objects to keep.
